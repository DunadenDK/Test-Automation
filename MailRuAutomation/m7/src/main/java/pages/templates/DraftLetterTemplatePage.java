...
public class DraftLetterTemplatePage extends BasePage {
  ...
  //  private static final String SUBJECT_FIELD = "//div[@class='mail-Compose-Field-Input']/input[contains(@name, 'subj')]";
    ...
    @FindBy(xpath = "//input[@class = 'container--H9L5q size_s--3_M-_' and @tabindex = '100']")
    ...
    @FindBy(xpath = "//button[@title = 'Свернуть']")
   ...
   // private WebElement captchaInput;
    ...
    protected void waitForPageToBeLoaded() {
        WaitUtils.waitUntilVisibilityOfElementLocatedBy(driver, By.xpath("//button[@title = 'Свернуть']"));
    }
